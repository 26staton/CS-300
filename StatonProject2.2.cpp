// StatonProject2.2.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
//============================================================================
// Name        : StatonProject2.2.cpp
// Author      : Timothy Statpm
// Version     : 2.0
...
void main() {
    ...
    cout << "Welcome to your planner." << endl << endl;
    ...
    while (userInput != 9) {
        ...
        case 1:
            cout << endl;
            cout << "What is the name of the file you would like to load?  Default file is Course.csv ";
            cin >> fileChoice;
        ...
        case 2:
            ...
            //prints course that user chooses
        case 3:
            cout << endl;
